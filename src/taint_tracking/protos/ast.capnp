...
# Porting choice: keep the earlier provided schema snapshot here because the
# current forward-ported ast_serialization.cc was aligned against it. Late patch
# series additions still need a separate reconciliation pass if we port the
# broader symbolic-execution consumer stack.
@0xd323f4577284d1c3;
