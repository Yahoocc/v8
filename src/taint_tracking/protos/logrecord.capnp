# This file was introduced by the original taint-tracking patch series.
# Upstream V8 14.8 has no native counterpart for this schema.
# Porting choice: recover the late patch-series log schema here so downstream
# sink/source and stack-trace records remain available for future ports.
# TODO(porting): build-verify this schema against the modern Cap'n Proto code
# generation path once BUILD.gn support is restored.
@0x9b61a0c1a03f2616;
